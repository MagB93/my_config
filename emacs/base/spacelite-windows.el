...
(defun spacelite/init-windows ()
  ;; init keys
  (spacelite/set-leader-keys "w/"
    'spacelite/split-window-right-and-focus "w-"
    'spacelite/split-window-below-and-focus "wh"
    'evil-window-left "wj" 'evil-window-down "wk"
    'evil-window-up "wl" 'evil-window-right "wd"
    'delete-window "w TAB" 'spacelite/alternate-window))
